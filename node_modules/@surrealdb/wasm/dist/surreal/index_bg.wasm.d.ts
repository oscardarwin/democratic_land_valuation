...
export const __wbg_surrealwasmengine_free: (a: number, b: number) => void;
export const surrealwasmengine_execute: (a: number, b: number) => number;
export const surrealwasmengine_notifications: (a: number, b: number) => void;
export const surrealwasmengine_connect: (a: number, b: number, c: number) => number;
export const surrealwasmengine_export: (a: number, b: number) => number;
export const surrealwasmengine_import: (a: number, b: number, c: number) => number;
export const surrealwasmengine_version: (a: number) => void;
